					...
					<tbody id='element_list'>
						@foreach($newslist as $image)
                         <tr class="mala-tr">
                            ...
                            <td class="mala-td"><a href="./newsdetail?Content_ID={{$image['Content_ID']}}" class="mala-mr js-edit">编辑</a> <a href="../api/delmaterials?Content_ID={{$image['Content_ID']}}" class="mala-mr js-edit">删除</a>  <a class="mala-mr js-edit" href="../admin/newspreview?Content_ID={{$image['Content_ID']}}">预览新闻</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
